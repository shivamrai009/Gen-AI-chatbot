...
function getToken() {
  ...
  return localStorage.getItem("gitlab_chat_token");
}

function getUser() {
  if (typeof window === "undefined") return null;
  return localStorage.getItem("gitlab_chat_user");
}

function clearAuth() {
  localStorage.removeItem("gitlab_chat_token");
  localStorage.removeItem("gitlab_chat_user");
}
...
async function sendFeedback(traceId, vote, comment = "") {
...
async function sendChatStream(question, history = [], handlers = {}) {
      ...
      <div className="msg-ai-block">
        {msg.route && (
          <div className="msg-meta-bar">
            ...
            {msg.criticPassed !== undefined && msg.criticPassed !== null && (
    ...
    <div className="chat-page">
      ...
      <aside className={`chat-sidebar ${sidebarOpen ? "open" : ""}`}>
        <div className="sidebar-header">
          <div className="logo-wrap" style={{ cursor: "pointer" }} onClick={() => router.push("/")}>
