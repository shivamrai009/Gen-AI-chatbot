...
export default function Landing() {
  ...
  function handleStart() {
    const token = typeof window !== "undefined" ? localStorage.getItem("gitlab_chat_token") : null;
    ...
    <div className="landing">
      ...
      <nav className="landing-nav">
        ...
        <div className="landing-nav-links">
          ...
          <button className="nav-btn-primary" onClick={() => router.push("/register")}>Get started</button>
        </div>
      </nav>
      ...
      <footer className="landing-footer">
        <p>Built with Gemini 2.0 Flash · Next.js · Knowledge Graph RAG</p>
